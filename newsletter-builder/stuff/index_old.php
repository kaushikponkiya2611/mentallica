    ...
    <body class="edit">
        <div class="navbar navbar-inverse navbar-fixed-top navbar-layoutit">
            <div class="navbar-header">
                ...
                <a onclick="return confirm('message for exit action');" class="btn btn-warning" href="#">back</a>
            </div>
                                                ...
                                                <tr>
                                                    <td class="social" align="center" style="padding: 15px 50px 15px 50px;">
                                                        <a href="#" style="border: none;" class="facebook">
                                                            <img border="0" src="<?php echo $path;?>/img/builder/facebook.png" />

                                                        </a>
                                                        <a href="#" style="border: none;" class="twitter">

                                                            <img border="0" src="<?php echo $path;?>/img/builder/twitter.png"/>


                                                        </a>
                                                        <a href="#" style="border: none;" class="linkedin">

                                                            <img  border="0" src="<?php echo $path;?>/img/builder/linkedin.png"/>


                                                        </a>
                                                        <a href="#" style="border: none;" class="youtube">

                                                            <img border=0 src="<?php echo $path;?>/img/builder/youtube.png"/>
...
if(!isset($contenuto)) $contenuto = ''; // variable must be declared    
if(isset($_GET['filename']) AND strlen($_GET['filename'])){  
 ...
 } else if(file_exists('tmp/body_' . $tplname)){                      
   $contenuto = file_get_contents('tmp/body_' . $tplname);            
 }
}
