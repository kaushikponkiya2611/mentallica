...
(function ($, window, document, undefined) {
    ...
    var imageViewHtml = '<div class="iv-loader"></div> <div class="iv-snap-view"><div class="plus-minus" style="font-size:50px;color:red;font-weight:bold"><div><a class="plustozoom" href="javascript:void(0)"><i class="fa fa-plus"></i></a></div><div><a href="javascript:void(0)" class="minustozoom" id="minustozoom"><i class="fa fa-minus"></i></a></div></div>' + '<div class="iv-snap-image-wrap" style="display:none">' + '<div class="iv-snap-handle"></div>' + '</div>' + '<div class="iv-zoom-slider" style="display:none"><div class="iv-zoom-handle"></div></div></div>' + '<div class="iv-image-view" ><div class="iv-image-wrap" ></div></div>';
    ...
    ImageViewer.prototype = {
        ...
        _init: function () {
            ...
            //plus minus to zoom
            $('.plustozoom').on('click' + eventSuffix, function (e) {
                ...
                var location = $('.iv-large-image').offset();
                var center = new Object();
                center.x = location.left + ($('.iv-large-image').outerWidth() / 2);
                center.y = location.top + ($('.iv-large-image').outerHeight() / 2);
                //alert(zoomValue);
                x = center.x;
                y = center.y;
            ...
            $('.minustozoom').on('click' + eventSuffix, function (e) {
                if (!options.zoomOnClick)
                    return;
                if (!viewer.loaded)
                    return;
                ...
                var location = $('.iv-large-image').offset();
                var center = new Object();
                center.x = location.left + ($('.iv-large-image').width() / 2);
                center.y = location.top + ($('.iv-large-image').height() / 2);
