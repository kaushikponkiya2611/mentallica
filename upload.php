...
require('admin/mp3file.class.php');
if(!empty($_FILES)){
	...
	if(move_uploaded_file($_FILES['file']['tmp_name'],$targetFile)){
			...
			$sql = "select * from tbl_music order by id desc limit 1";
			...
			$conn->query("INSERT INTO tbl_music (uid,cid,title,image,time,start_time,end_time,cr_date,status) VALUES('".$userid."','".$sel_category."','".$fileName."','".$fileName."','".$time."','".$stime."','".$endtime."','".date("Y-m-d H:i:s")."','1')");
