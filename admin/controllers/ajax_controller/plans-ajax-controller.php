...
if (isset($_POST['view']) && $_POST['view'] != '') {
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size:13px"><tr class="white_bg">
        ...
        <tr class="white_bg">
            <td width="120" align="right" class="popup_listing_border"><strong>Tooltip:</strong></td>
            <td width="11" height="37" align="left" class="popup_listing_border">&nbsp;</td>
            <td width="469" align="left" class="popup_listing_border"><?php echo stripslashes($result['tooltip']) ?></td>
        </tr>
        <tr class="light_bg">
...
if (isset($_POST['hid_update']) && $_POST['hid_update'] != '') {
    ...
    if ($flag == 1) {
        ...
        $qry = "UPDATE tbl_plans SET tooltip = '".clear_input($_POST['tooltip'])."', plan_name = '" . clear_input($_POST['txt_addplan_name']) . "',plan_price = '" . clear_input($_POST['txt_addplan_price']) . "',image_limit = '" . clear_input($imagelimit) . "',month = '" . clear_input($_POST['txt_addmonth']) . "',category = '" . clear_input(implode(",", $_POST['txt_addcategory'])) . "'WHERE id = '" . mysql_real_escape_string($_POST['hid_userid']) . "'";
        $result = $modelObj->runQuery($qry);
        echo "1";
    } else {
        echo "0";
    ...
    <script type="text/javascript" src="<?= $LOCATION['SITE_ADMIN'] ?>views/javascripts/js/jquery.form.js"></script><form name="form_plansadd" id="form_plansadd" method="post" enctype="multipart/form-data" action="#" >
        <table border="0" cellpadding="0" cellspacing="0"  id="id-form" width="100%"><tr class="white_bg">
            ...
            <tr class="white_bg">
                <th>Tooltip : </th>
                <td width="23%">
                    <input class="input_box" type="text" name="tooltip" id="txt_addmonth" value="<?php echo stripslashes($data['tooltip']) ?>" onblur="checkfield(this)"><font class="required"> *</font>
                </td>
                <td id="errortxt_addmonth" width="57%">
                    <label class="removerror error_new" id="error-innertxt_addmonth"></label>
                </td>
