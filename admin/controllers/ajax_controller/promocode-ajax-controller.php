                                                            ...
                                                            <tr>
                                                                    <td width="600" style="border:1px solid #336699;">
                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                    ...
                                                                                    <tr>
                                                                                            <td colspan="2" height="20" style="padding:0px 20px;">Please use below promocode to signup with mentallica and get benefit of promo code.</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td colspan="2" height="10"></td>
                                                                                    </tr>                                                                                    
                                                                                    <tr>
                                                                                            <td colspan="2" height="20" style="padding:0px 20px;">'.$_POST['txt_addpromo_code'].'</td>
                                                                                    </tr>
                                                                                    <tr>
                                                            ...
                                                            <tr>
                                                                    <td width="600" style="border:1px solid #336699;">
                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                    ...
                                                                                    <tr>
                                                                                            <td colspan="2" height="20" style="padding:0px 20px;">Please use promocode to signup with mentallica and get benefit of promo code.</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td colspan="2" height="10"></td>
                                                                                    </tr>                                                                                    
