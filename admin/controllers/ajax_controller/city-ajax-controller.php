...
<tr>
	...
	<a onclick="sortingbyfield('c.name','<?php if($orderby=='asc'){echo "desc";}else{echo "asc";} ?>')" id="c_name" class="cursorpointer">City Name </a></th>
	<th class="table-header-repeat line-left minwidth-1">
	<a onclick="sortingbyfield('stateName','<?php if($orderby=='asc'){echo "desc";}else{echo "asc";} ?>')" id="s_stateName" class="cursorpointer">State Name </a></th>
	<th class="table-header-repeat line-left minwidth-1">
	<a onclick="sortingbyfield('countryName','<?php if($orderby=='asc'){echo "desc";}else{echo "asc";} ?>')" id="co_countryName" class="cursorpointer">Country Name </a></th>
