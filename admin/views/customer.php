<script type="text/javascript">
	...
	<script type="text/javascript" src="<?=$LOCATION['SITE_ADMIN']?>views/javascripts/customerscripts.js"></script>
	  ...
	  <table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
		  <tr>
			<td width="635" height="35" class="popup_bg" ><table width="620" border="0" cellspacing="0" cellpadding="0" align="left">
				<tr>
				  <td colspan="2" >Upload Customer CSV</td>
				</tr>
			  </table></td>
		  </tr>
		  <tr>
			<td height="20" align="right" class="popup_listing_border"><a href="<?=$LOCATION['SITE_ADMIN']?>csv-examples/customer.csv">Example of CSV Format</a></td>
		  </tr>
		  <tr>
	  ...
	  <div id="<?php echo $_GET['pid'] ?>" >
		<div class="searchdiv">
		  <table class="searchdiv" border="0" width="100%" cellpadding="0" cellspacing="0">
			...
			if($controller_class -> getcustomer != ''){
			?>
		...
		<form id="form_customerview" action="" name="form_customerview" method="post" enctype="multipart/form-data" >
	   ...
	   $i = 0;
		if($controller_class -> getcustomer != ''){
			foreach($controller_class -> getcustomer  as $k => $data){
				$i++;
	  ?>
			<tr id="<?php echo $data['id']?>" class="<?php if($i%2==0){ echo "light_bg"; }else{ echo "white_bg"; } ?>" height="30">
			  <td><input  type="checkbox" name="chk_id" id="chk_id" value="<?php echo $data['id'];  ?>"/></td><td class="cursorpointer" onclick="edit('<?php echo $data['id'] ?>','<?php echo $_GET['pid']?>')"><?php echo $data['username']; ?></td><td><?php echo $data['emailid']; ?></td><td><?php echo $data['mobileno']; ?></td><td class="options-width" ><table>
				  <tr>
					<td><?php
							if($data['status'] == '1')
							{
