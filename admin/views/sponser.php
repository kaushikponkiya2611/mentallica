<script type="text/javascript">
	...
	<script type="text/javascript" src="<?=$LOCATION['SITE_ADMIN']?>views/javascripts/sponserscripts.js"></script>
	  ...
	  <table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
		  <tr>
			<td width="635" height="35" class="popup_bg" ><table width="620" border="0" cellspacing="0" cellpadding="0" align="left">
				<tr>
				  <td colspan="2" >Upload sponser CSV</td>
				</tr>
			  </table></td>
		  </tr>
		  <tr>
			<td height="20" align="right" class="popup_listing_border"><a href="<?=$LOCATION['SITE_ADMIN']?>csv-examples/sponser.csv">Example of CSV Format</a></td>
		  </tr>
		  <tr>
	  ...
	  <div id="<?php echo $_GET['pid'] ?>" >
		<div class="searchdiv">
		  <table class="searchdiv" border="0" width="100%" cellpadding="0" cellspacing="0">
			...
			if($controller_class -> getsponser != ''){
			?>
		...
		<form id="form_sponserview" action="" name="form_sponserview" method="post" enctype="multipart/form-data" >
	   ...
	   $i = 0;
		if($controller_class -> getsponser != ''){
			foreach($controller_class -> getsponser  as $k => $data){
				$i++;
	  ?>
			...
			<tr height="30">
			  <td colspan="7" align="center" style="color:#FF0000"><strong><?php echo "No sponser found."; ?></strong></td>
			</tr>
			<?php } ?>
		  </table>
		  <?php 
