...
<script type="text/javascript" src="<?php echo $LOCATION['SITE_ADMIN']?>views/javascripts/cityscript.js"></script>
        	...
        	<form id="form_search" action="" name="form_search" method="post" enctype="multipart/form-data" >
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
				  ...
				  <tr class="white_bg">
					...
					<td width="11" height="37" align="left" class="popup_listing_border">&nbsp;</td>
					<td width="469" align="left" class="popup_listing_border" valign="middle">
					<input type="text" class="input_box"  name="txt_statea" id="txt_statea"  />
					</td>
				  </tr>
				  <tr class="light_bg">
					...
					<td width="11" height="37" align="left" class="popup_listing_border">&nbsp;</td>
					<td width="469" align="left" class="popup_listing_border" valign="middle">
					<input type="text" class="input_box"  name="txt_countrya" id="txt_countrya"  />
					</td>
				  </tr>
				  <tr class="white_bg">
					<td align="right">&nbsp;</td>
...
<table class="searchdiv" border="0" width="100%" cellpadding="0" cellspacing="0">
   <tr>
	...
	<tr>
		...
		<a onclick="sortingbyfield('c.name','asc')" id="c_name" class="cursorpointer">City Name </a></th>
		<th class="table-header-repeat line-left minwidth-1">
		<a onclick="sortingbyfield('stateName','asc')" id="s_stateName" class="cursorpointer">State Name </a></th>
		<th class="table-header-repeat line-left minwidth-1">
		<a onclick="sortingbyfield('countryName','asc')" id="co_countryName" class="cursorpointer">Country Name </a></th>
		<th class="table-header-options line-left"><a>Options</a></th>
	</tr>
   <?php
   $i = 0;
	if($controller_class -> getcity != ''){
		foreach($controller_class -> getcity  as $k => $data){
			$i++;
  ?>
