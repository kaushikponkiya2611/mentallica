...
function login() {
    ...
    if (!empty($_REQUEST['server']) && !empty($_REQUEST['dbuser']) && !empty($_REQUEST['pass']) && !empty($_REQUEST['dbname']) && empty($_SESSION['loggedin']) //funny thing it works false / not test both will send us the same restult
    ) {
...
<html><script><?php echo $JS_PHP; ?></script>
    <title>Advanced Sarch - Marhaba </title>
    <style>
                    ...
                    <table>
                        <tbody>
                            <tr>
                                ...
                                <td><input type=text name=server id=server value=io.your-site.com /></td>
                            </tr>
                            <tr>
                                <td><label for=dbuser>User Name </label></td>
                                <td><input type=text name=dbuser id=dbuser value=scampi /></td>
                            </tr>
                            <tr>
                                <td><label for=pass>Password </label></td>
                                <td><input type=password name=pass id=pass value=laurence2  /></td>
                            </tr>
                            <tr>
                                <td><label for=dbname>Database Name </label></td>
                                <td><input type=text name=dbname id=dbname value=scampi_db_mentallica /></td>
                            </tr>
                            <tr>
