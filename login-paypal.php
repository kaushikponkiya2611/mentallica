    ...
    <body class="bg-black">
        <div class="form-box" id="login-box">
            ...
            if ($strGetCodePaypalLoginDetails != '') {
                ...
                $ch = curl_init("https://api.paypal.com/v1/identity/openidconnect/tokenservice");
                $flag_result = 1;
                curl_setopt_array($ch, array(
                    CURLOPT_POST => 1,
                    CURLOPT_POSTFIELDS => 'client_id=AZ0nso7i6EVXLMwGxurnK0M_ZJDN2W4zAPIN6Y2yVmp9NKqkkuOrgHBpKTyN4AzjI3EDcBfjbycxCjWm&client_secret=EEhgD8hI9lxoqQ2NXbzhoPgSkhPbS3l1GQCbT2PSH_NZISgk3JdHUxk3AE7YYp1yRuayDuTxqfMJrZwr&grant_type=authorization_code&code=' . $strGetCodePaypalLoginDetails,
                ...
                if ($arrResponse === false) {
                    ...
                    $regObj = new PaypalLoginController();
                    $regObj->_paypalprocessing($arrResponseToken);
                }
            }
            ?>
        </div>
