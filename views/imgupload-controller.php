...
class ImguploadController extends CommonController {
            ...
            if (isset($_FILES["file_img_upload"]["tmp_name"])) {
                ...
                if ($_FILES["file_img_upload"]["tmp_name"] != '') {
                    ...
                    if (move_uploaded_file($tmpfile, $upload_dir . $insertimage)) {
                        ...
                        $usr_insert_img = $this->insertuserimage($insertimage, $_POST['txt_img_title'],$_POST['txt_img_text'] ,$image_rules, $_POST['sel_currency'], $_POST['txt_img_price'], $_POST['txt_dwn_price'], $_POST['sel_category'], $this->userdetail['image_limit'], $targetFile, $_POST['sel_subcategory'], $cutcoins,$file_size1);
                    }
                }
            }
    ...
    function insertuserimage($insertimage, $imgtitle, $imgtext,$image_rules, $currency, $imgprice, $imgdwnprice, $catid, $imglimit, $musicnewname, $subcatid, $cutcoins,$file_size1) {
