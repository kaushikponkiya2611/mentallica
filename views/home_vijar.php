<body class="skin-blue">
        ...
        <aside class="">
            ...
            <section class="">
                ...
                <div class="container">
                    ...
                    <div class="row home-cont-row">
                        ...
                        foreach ($controller_class->homecategorylist as $key => $catdata):
                            ...
                            foreach($numAreas as $kk=>$vvv){
                               $randomNumbera = rand(0, (count($numAreas) - 1));
                               $userimagesstr.= ',slide'.$numAreas[$randomNumbera].'.jpg'; 
                            }
                            $userimagesstr=trim($userimagesstr,",");
                            
                            $photoAreas = array("artist/slide1.jpg", "artist/slide2.jpg", "artist/slide3.jpg", "artist/slide4.jpg", "artist/slide5.jpg");
                            ...
                            for ($i = 0; $i < count($explode_artist_id); $i++) {
                                ...
                                if ($explode_artist_id[$i] != '') {
                                    ...
                                    $all_artist_image[] = $photoAreas[$randomNumber];
                                    $varset=1;
                                }
                            }
                            ...
                            <div class="col-lg-3 col-md-3 col-xs-6">
                                <div class="portfolio-item">
                                    <h3>
                                        <?php echo $catdata['categoryName']; ?>
                                    </h3>
                                    <a href="<?php echo $_SESSION['FRNT_DOMAIN_NAME'] . "artistlist/" . $catdata['id']; ?>">
                                        <div class="portfolio-item-images">

                                            <div class="clearfix rot-cat-usr-imgs"
                                                 id="cat_<?php echo $catdata['id']; ?>"
                                                 style="min-height: 218px; background-image: url('<?php echo $_SESSION['SITE_NAME'] . "img/no-profile-picture-icon-620x389.jpg"; ?>'); background-size: cover; background-repeat: no-repeat; background-position: 50% 50%;" data-userimages="<?php
                                                 if ($varset == 0) {
                    ...
                    <div class="row home-cont-row">
                        <div class="col-lg-12 col-md-12 col-xs-12" style="margin:26px 0px">


                            <div class="col-md-2 col-sm-4 col-xs-4 mgb10_ipda" style="text-align: center">
                                <div class="home_page_logo">
                                    <a href="#"><img src="http://www.fmfm.de/upload/brand/020217140932panasonic_for_professionals_poster_.png" title="Panasonic" alt="img"></a>
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-4 mgb10_ipda" style="text-align: center">
                                <div class="home_page_logo">
                                    <a href="#"><img src="http://www.fmfm.de/upload/brand/020217140932panasonic_for_professionals_poster_.png" title="Olivia Garden" alt="img"></a>
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-4 mgb10_ipda" style="text-align: center">
                                <div class="home_page_logo">
                                    <a href="#"><img src="http://www.fmfm.de/upload/brand/020217140932panasonic_for_professionals_poster_.png" title="Denman" alt="img"></a>
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-4 mgb10_ipda" style="text-align: center">
                                <div class="home_page_logo">
                                    <a href="#"><img src="http://www.fmfm.de/upload/brand/020217140932panasonic_for_professionals_poster_.png" title="Glynt" alt="img"></a>
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-4 mgb10_ipda" style="text-align: center">
                                <div class="home_page_logo">
                                    <a href="#"><img src="http://www.fmfm.de/upload/brand/020217140932panasonic_for_professionals_poster_.png" title="Parlux" alt="img"></a>
                                </div>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-4 mgb10_ipda" style="text-align: center">
                                <div class="home_page_logo">
                                    <a href="#"><img src="http://www.fmfm.de/upload/brand/020217140932panasonic_for_professionals_poster_.png" title="ESTEL" alt="img"></a>
                                </div>
                            </div>
    ...
    <div class='footer-main'>
        <div class='container'>
            <div class='row'>
                ...
                <div class='col-md-6'>
                    <div class='artwork-to-the-world-texts'>
                        <h4>We show your Artwork to the world</h4>
                        <p>THE WORLD IS A BIG PLACE AND ARTISTS CAN NOT ATTEND TO  EVERY INTERSTING EXPOSTION OR EVENT WORLDWIDE. MENTALLICA IS BESIDES BEING A WINDOW TO THE WORLD  AN ART AGENCY DESIGNED TO GET THE ARTIST CONNECTED WORLD WIDE.</p>
                        <p>UPLOAD YOUR ART WORK ARTISTS BUY A SUBSCRIPTION THAT FITS YOUR CURRENT NEEDS OR GET EXTRA BITS TO UPLOAD REPORT A FALSE BID ARTISTS GET A PREFERRED ACCOUNT WITH ACTIVE PROMOTION BY MENTALLICA AGENTS MARKET ANALYTICS</p>
                    </div>
                </div>
                <div class='col-md-5 col-md-offset-1'>
                    <div class='footer-button'>
                        <div class='footer-button-title'>
                            <h4>Mentallica Radio</h4>
                        </div>
                        <div class='footer-button-img01'>
                            <a href=''><img src='img/mentallica-radio.png'></a>
                        </div>
                    </div>
                    <div class='footer-button'>
                        <div class='footer-button-title'>
                            <h4>Mentallica Follow</h4>
                        </div>
                        <div class='footer-button-img02'>
                            <a href=''><img src='img/mentallica-follow.png'></a>
                        </div>
                    </div>
                    <div class="clear"></div>
                    ...
                    <form action="" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form " class="mc-embedded-subscribe-form" target="_blank" data-animate-type="" novalidate="">

                        <input autocomplete="off" value="" name="EMAIL" class="required email rd-field form-control" required="" id="mce-EMAIL" placeholder="Email Address" data-constraints="@NotBlank @HTML5Required @Length(min=&quot;0&quot;, max=&quot;72&quot;, ignoreEmpty=&quot;1&quot;) @Pattern(regex=&quot;/^(.{1,64})\@/&quot;) @Email @HTML5Email" type="email">

                        <div class="submit-wrap">
                            <button type="submit" name="subscribe"  id="mc-embedded-subscribe" value="Subscribe">Subscribe</button>
                        </div>
        ...
        <div class='bottom-footer'>
            <div class='col-md-12'>
                <p>MENTALLICA,LLC WORLDWIDE LIVING ART AUCTIONS, MARRIAGE OF THE ARTS AND ART INTERIM</p>
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            (function loop() {
                var rand = Math.round(Math.random() * (3000 - 100)) + 10;
                setTimeout(function() {
