                                ...
                                <div class="collapse navbar-collapse navbar-menubuilder data_left_menu ">
                                    <ul class="nav navbar-nav navbar-right">
                                        ...
                                        if (isset($_SESSION['po_userses']['flc_usrlogin_type']) && $_SESSION['po_userses']['flc_usrlogin_type'] == 3) {
                                            ?>
                                            <li class=""><a href="<?php echo $_SESSION['FRNT_DOMAIN_NAME']; ?>artistspage">Artists Page</a></li>
                                            <?php
                                        }
                                        ?>
                                        <!-- end -->
                                        ...
                                        <?php
                                        if (isset($_SESSION['po_userses']['flc_usrlogin_type']) && ($_SESSION['po_userses']['flc_usrlogin_type'] == 1 or $_SESSION['po_userses']['flc_usrlogin_type'] == 3)) {
                                            ?>
                                            <li class=""><a href="<?php echo $_SESSION['FRNT_DOMAIN_NAME']; ?>notification">Notifications</a></li>
                                            <?php
                                        }

                                        $acc = $controller_class->checkcompanypageAccess('full_profile_access', '');
                                        if ($_SESSION['po_userses']['flc_usrlogin_type'] == 1 or $acc == 1) {
                                            ?><li><a href="<?php echo $_SESSION['FRNT_DOMAIN_NAME']; ?>artistsimages">My Content</a></li><?php
                                            }
                                            ...
                                            if ($previewcategorylist) {
                                                foreach ($previewcategorylist as $k => $catlist) {
                                                    $previewcategories[] = $catlist['id'];
                                                }
                                            }
                                            $acc = $controller_class->checkcompanypageAccess('categories_access', $previewcategories[0]);
                                            $acc2 = $controller_class->checkcompanypageAccess('full_profile_access', $previewcategories[0]);
                                            if ($_SESSION['po_userses']['flc_usrlogin_type'] == 1 or $acc == 1 or $acc2 == 1) {
                                                ?><li><a href="<?php echo $_SESSION['FRNT_DOMAIN_NAME']; ?>preview/<?= $previewcategories[0] ?>">My Page</a></li><?php
                                            }

                                            if ($_SESSION['po_userses']['flc_usrlogin_type'] == 1 or $acc == 1) {
                                                ?><li><a href="<?php echo $_SESSION['FRNT_DOMAIN_NAME']; ?>imgupload">Upload</a></li><?php
                                            }
                                  ...
                                  <!--  <li><a href="<?php echo $_SESSION['FRNT_DOMAIN_NAME']; ?>radio">Make Radio Host</a></li>-->
                                        <?php if (isset($_SESSION['po_userses']['flc_usrlogin_id']) && $_SESSION['po_userses']['flc_usrlogin_id'] != ''): ?>                                
                                            ...
                                            <li>
                                                <a href="<?php echo $_SESSION['FRNT_DOMAIN_NAME']; ?>wallet/">Wallet</a>
                                            </li>
                                            <li>
                                        ...
                                        <?php else: ?>
                                            ...
                                            <?php
                                            //$_COOKIE['userlogin'] = "no";
                                            if(isset($_COOKIE['userlogin']) && $_COOKIE['userlogin']=='yes'){
                                                ?>
                                                <li>
                                                   <a href="#connect-login-paypal" class="fancybox">
                                                        <span><b>Connect with paypal</b></span>
                                                    </a> 
                                                </li>
<!--                                                <li class="pp">
                                                ...
                                                ?>
                                                <li class="user-header">
                                                    <a href="#inline-pop-select-user-exist" class="connectPP fancybox">
                                                        <span><b>Connect to paypal</b></span>
                                                    </a>
                                                </li>
                                                <?php
                                            }
...
<div id="inline-pop-select-user-exist" style="max-width:900px;display: none;">
    <div id="login-box" class="form-box">
        <?php
            ...
            if(isset($_SESSION['po_userses']['login_error']) && $_SESSION['po_userses']['login_error'] != ''){
                ...
                ?>
                <h4><?php echo $_SESSION['po_userses']['login_error']; ?></h4>    
                <?php
            }
        ?>
        ...
        <ul>
            ...
            <li style="display: block; padding: 8px;">
                <a href="#connect-login-paypal" class="fancybox paypalBtn">
                     <span><b>Connect with paypal</b></span>
                 </a> 
             </li>
        </ul>
 ...
 <div id="connect-login-paypal" style="max-width:900px;display: none;">
    <div id="login-box" class="form-box">
        <div class="header">Sign In</div>
        <form method="post" action="#">
            <div class="body bg-gray formBtn">
                <input type="text" class="form-control" name="userEmail" placeholder="Enter registered email.." id="userEmail"/>
                <div class="login-div">
                    <a class="btn btn-primary btnUserLogin" href="javascript:void(0)">Login</a>
                </div>
            </div>
            
            <li class="user-header myBtn" style="display:none;text-align: center; list-style: outside none none; margin-top: 15px;">
                <span id='lippButton'></span>
            </li>
        </form>
    </div>
...
<div id="inline-pop-login-artist" style="max-width:900px;display: none;">
    <div id="login-box" class="form-box">
        ...
        <form method="post" action="<?php echo $_SESSION['FRNT_DOMAIN_NAME']; ?>login/artist">
    ...
    <div id="login-box" class="form-box">
        ...
        <form method="post" action="<?php echo $_SESSION['FRNT_DOMAIN_NAME']; ?>register/artist">
            <div class="body bg-yellow">
                ...
                <div class="form-group">
                    <textarea id="u_r_address" placeholder="Address" class="form-control" name="u_r_address"></textarea>
                </div>
...
<div id="inline-pop-payment-mentallica-artist" style="max-width:900px;display: none;">
    <div id="login-box" class="form-box">
        ...
        <form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
            ...
            <input type='hidden' name='cancel_return' value='<?php echo $_SESSION['FRNT_DOMAIN_NAME']; ?>cancel'>
            <input type='hidden' name='return' value='<?php echo $_SESSION['FRNT_DOMAIN_NAME']; ?>paypal/paypal_success.php'>
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function () {
        ...
        jQuery(".btnUserLogin").click(function(){
            ...
            if(userEmail==''){
                ...
                jQuery.ajax({
                    method: "POST",
                    url: site_url + "controllers/ajax_controller/paypallogin-ajax-controller.php",
                    data: {userEmail: userEmail,action:"check-login"}
                })
                .done(function (data) {
                    if(data.trim()=='found'){
                        jQuery(".formBtn").hide();
            ...
            $.ajax({
                ...
                data: {followmentallicaartistchk: "followmentallicaartistchk", artistname: workid}
                    ...
                    .done(function (data) {
                        //alert(data);
                        if (data.trim() == 4) {
                            alert("You have successfully unfollowing this artist.");
                            jQuery(".follow-artist").html("Follow Artist");
                            ...
                            jQuery(".follow-artist").html("Unfollow Artist");
                        }
                    });
        });
    ...
    jQuery(window).on('load', function () {
        <?php
        //if(isset($_SESSION['po_userses']['login_error']) && $_SESSION['po_userses']['login_error'] != ''){
        if(isset($_SESSION['loginActivate']) && $_SESSION['loginActivate'] != ''){
        
            ?>
            jQuery(".connectPP").trigger("click");
            <?php
    ...
    function bodytopspaceMobile() {
        if (jQuery(window).width() < 768) {
            var headerHeight = jQuery('.header-main.header-main-sub').outerHeight()
