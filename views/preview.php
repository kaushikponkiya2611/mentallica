                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <button type="button" class="btn btn-default btnCancle" data-dismiss="modal">Close</button>
                                                        ...
                                                        <div id="introduction____">
                                                            <div id="timelineContainer" style="margin-top:10px">
                                                                ...
                                                                <div id="timelineProfilePic">
                                                                    ...
                                                                    ?>
                                                                    <img class="custom-file-input" id="profile_picture_<?= $catdetail['id'] ?>"  src="<?php echo $profile_pic; ?>" style="width:100%; height:100%;" >
    ...
    <script>
        ...
        function showResponseProfileImage1(data, statusText) {
            if (statusText == 'success') {
                if (data != '0') {
                    var data2 = data.split('|x|');
                    var a = data2[0].trim();
                    $("#profile_picture_" + a).attr('src', data2[1]);
                } else {
