...
<div class="container">
    <div class="row">
		<div class="col-md-12">
            ...
            <a class="navbar-brand  logo-main" href="#"><img src="<?php echo $_SESSION['SITE_NAME'];?>img/logo.png" alt="logo" /></a>
             ...
             <div class="collapse navbar-collapse navbar-menubuilder">
                <ul class="nav navbar-nav navbar-right">
                    <li <?php if($_REQUEST['pid']=='') { echo 'class="active"'; } ?>><a href="<?php echo $_SESSION['FRNT_DOMAIN_NAME'];?>">Home</a></li>
					
                    <li <?php if($_REQUEST['pid']=='aboutus') { echo 'class="active"'; } ?>><a href="<?php echo $_SESSION['FRNT_DOMAIN_NAME'];?>aboutus">About Us</a></li>
                    <li <?php if($_REQUEST['pid']=='artist') { echo 'class="active"'; } ?>><a href="<?php echo $_SESSION['FRNT_DOMAIN_NAME'];?>artist">Artist</a></li>
                    <li <?php if($_REQUEST['pid']=='company') { echo 'class="active"'; } ?>><a href="<?php echo $_SESSION['FRNT_DOMAIN_NAME'];?>company">Company</a></li>
                    
                    <?php if($_SESSION['po_userses']['flc_usrlogin_type'] == 1):?>
                    <li><a href="<?php echo $_SESSION['FRNT_DOMAIN_NAME'];?>artistsimages">My Images</a></li>
                    <li><a href="<?php echo $_SESSION['FRNT_DOMAIN_NAME'];?>preview">Preview</a></li>
                    <li><a href="<?php echo $_SESSION['FRNT_DOMAIN_NAME'];?>imgupload">Upload Image</a></li>
                  <!--  <li><a href="<?php echo $_SESSION['FRNT_DOMAIN_NAME'];?>radio">Make Radio Host</a></li>-->
                    ...
                    <?php endif; ?>
					 <?php if(isset($_SESSION['po_userses']['flc_usrlogin_id']) && $_SESSION['po_userses']['flc_usrlogin_id'] != ''):?>
                        ...
                        <li>
                            <a href="<?php echo $_SESSION['FRNT_DOMAIN_NAME'];?>profile/">Profile</a>
                        </li>
                        <li>
    ...
    <div id="login-box" class="form-box">
        ...
        <form method="post" action="<?php echo $_SESSION['FRNT_DOMAIN_NAME'];?>register/artist">
            <div class="body bg-yellow">
                ...
                <div class="form-group">
                    <input type="text" name="u_r_username" class="form-control" placeholder="Username" pattern="[a-zA-Z0-9]+" required />
                </div>
                <div class="form-group">
                ...
                <div class="form-group statelistartistwrap" style="display: none;">
...
<script type="text/javascript">
    ...
    function openChatDetail (chatdata) {
        ...
        $.ajax({
            ...
            refreshIntervalId = setInterval( function(){ openChatDetailInterval(chatdata); }, 3000);
        });
    }
