                                        ...
                                        <li>
                                            ...
                                            <script>
                                                paypal.use( ['login'], function (login) {
                                                  login.render ({
                                                    "appid":"AZcLHoXoSPV6C78ZJ7pAPy1Il635Fp2Qe1JTanmM7H6LAHFGKFxQv_SOA4xYmraHI3A7AwEiylXvzMDt",
                                                    "authend":"sandbox",
    ...
    <div id="login-box" class="form-box">
        ...
        <form method="post" action="<?php echo $_SESSION['FRNT_DOMAIN_NAME']; ?>register/artist">
            <div class="body bg-yellow">
                ...
                <div class="form-group">
                    <textarea   placeholder="Address" class="form-control" name="u_r_address"></textarea>
                </div>
            </div>
            <div class="footer">                    
...
<div id="inline-pop-payment-mentallica-artist" style="max-width:900px;display: none;">
    <div id="login-box" class="form-box">
        <div class="header">Payment Mentallica</div>
