            ...
            <div class=''>
                ...
                <div class="wrapper row-offcanvas row-offcanvas-left">
                    <div class="container">                            
                            ...
                            <div class="banner-and-text homevideo-bg">
                                <div class="col-md-6">
                                    <div class="rot-cat-banner-imgs">
                                        <video controls height="" src="<?php echo $FRNT_DOMAIN_NAME;?>upload/video/<?php echo $controller_class->homevideo[0]['image']; ?>">
                                        ...
                                        <a href="<?php echo $_SESSION['FRNT_DOMAIN_NAME'] . "artistlist/" . $catdata['id']; ?>">
                                            <div class="homeport-item-imgbox">
                                                <div class="clearfix rot-cat-usr-imgs homeport-item-img">
                                                    <?php
                                                    if ($varset == 0) {
                                                        ?><img id="myImage_<?=$catdata['id']?>" src="<?=$_SESSION['FRNT_DOMAIN_NAME']?>upload/<?=str_replace('"','',$all_artist_image[0])?>" alt="image test" class="arthomeimg" /><?php
                                                    }else{
                                                        ?><img id="myImage_<?=$catdata['id']?>" src="<?=$_SESSION['FRNT_DOMAIN_NAME']?>upload/<?=str_replace('"','',$userimagesstr_fimg[0])?>" alt="image test" class="arthomeimg" /><?php
                                                    }
                                                    ?>
                        ...
                        <!-- /.row -->
                        <div class="row home-cont-row artlogosection home_gallery_box">
                            <div class="container">
                                <div class="row">
