...
<script type="text/javascript" src="<?php echo $LOCATION['SITE_ADMIN'] ?>views/javascripts/countryscript.js"></script>
...
<div style="display:none;">
    <div id="inline_2" style="width:550px;min-height:150px;">
...
<div id="table-content">
    ...
    <div id="<?php echo $_GET['pid'] ?>" >
        <div class="searchdiv">
            <table class="searchdiv" border="0" width="100%" cellpadding="0" cellspacing="0">
                <tr>
                    <td width="13%">
                        <?php
                        if ($controller_class->getcountry != '') {
                            ?>
        ...
        <form id="form_userview" action="" name="form_cmsview" method="post" enctype="multipart/form-data" >
            <table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
                <tr>
                    ...
                    <th class="table-header-repeat line-left minwidth-1">
                        <a onclick="sortingbyfield('countryName', 'asc')" id="countryName" class="cursorpointer">Country Name </a></th>
                ...
                if ($controller_class->getcountry != '') {
                    foreach ($controller_class->getcountry as $k => $data) {
                        $i++;
                        ?>
                        ...
                        ?>" height="30">
                            ...
                            <td class="cursorpointer" onclick="edit('<?php echo $data['id'] ?>', '<?php echo $_GET['pid'] ?>')"><?php echo stripslashes($data['countryName']); ?></td>
            ...
            <input type="hidden" name="viewdiv" id="viewdiv" value="1" />
            <input type="hidden" name="totalcheck" id="totalcheck" value="<?php echo $controller_class->gettotalpageno ?>" />
        </form>
    </div>
</div>