<script type="text/javascript">
	...
	<script type="text/javascript" src="<?=$LOCATION['SITE_ADMIN']?>views/javascripts/offersscripts.js"></script>
	  ...
	  <table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
		  <tr>
			<td width="635" height="35" class="popup_bg" ><table width="620" border="0" cellspacing="0" cellpadding="0" align="left">
				<tr>
				  <td colspan="2" >Upload Offers CSV</td>
				</tr>
			  </table></td>
		  </tr>
		  <tr>
			<td height="20" align="right" class="popup_listing_border"><a href="<?=$LOCATION['SITE_ADMIN']?>csv-examples/offers.csv">Example of CSV Format</a></td>
		  </tr>
		  <tr>
				...
				<form id="form_search" action="" name="form_search" method="post" enctype="multipart/form-data" >
				  <table width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr>
						...
						<td width="130" align="right" class="popup_listing_border" valign="middle"><strong>OfferCategory:</strong></td>
						...
						<input type="text" class="input_box"  name="txt_srcofferCategory" id="txt_srcofferCategory" />	  
						</td>
					  </tr><tr class="light_bg">
						<td width="130" align="right" class="popup_listing_border" valign="middle"><strong>OfferName:</strong></td>
						<td width="11" height="37" align="left" class="popup_listing_border">&nbsp;</td>
						<td width="459" align="left" class="popup_listing_border" valign="middle">
						<input type="text" class="input_box"  name="txt_srcofferName" id="txt_srcofferName" />	  
						</td>
					  </tr><tr class="white_bg">
						<td width="130" align="right" class="popup_listing_border" valign="middle"><strong>OfferCode:</strong></td>
						<td width="11" height="37" align="left" class="popup_listing_border">&nbsp;</td>
						<td width="459" align="left" class="popup_listing_border" valign="middle">
						<input type="text" class="input_box"  name="txt_srcofferCode" id="txt_srcofferCode" />	  
						</td>
					  </tr><tr class="light_bg">
						<td width="130" align="right" class="popup_listing_border" valign="middle"><strong>Price:</strong></td>
						<td width="11" height="37" align="left" class="popup_listing_border">&nbsp;</td>
						<td width="459" align="left" class="popup_listing_border" valign="middle">
						<input type="text" class="input_box"  name="txt_srcprice" id="txt_srcprice" />	  
						</td>
					  </tr><tr class="white_bg">
						<td width="130" align="right" class="popup_listing_border" valign="middle"><strong>NeededPoints:</strong></td>
						<td width="11" height="37" align="left" class="popup_listing_border">&nbsp;</td>
						<td width="459" align="left" class="popup_listing_border" valign="middle">
						<input type="text" class="input_box"  name="txt_srcneededPoints" id="txt_srcneededPoints" />	  
						</td>
					  </tr><tr class="white_bg">
						<td align="right">&nbsp;</td>
	...
	<a id="various_2" href="#inline_2"></a><div id="table-content">
	  ...
	  <div id="<?php echo $_GET['pid'] ?>" >
		...
		<form id="form_offersview" action="" name="form_offersview" method="post" enctype="multipart/form-data" >
		  <table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
			<tr>
			  <th class="table-header-check"><a id="toggle-all" ></a> </th><th class="table-header-repeat line-left minwidth-1"> <a onclick="sortingbyfield('offerCategory','asc')" id="offerCategory" class="cursorpointer">OfferCategory</a></th><th class="table-header-repeat line-left minwidth-1"> <a onclick="sortingbyfield('offerName','asc')" id="offerName" class="cursorpointer">OfferName</a></th><th class="table-header-repeat line-left minwidth-1"> <a onclick="sortingbyfield('offerCode','asc')" id="offerCode" class="cursorpointer">OfferCode</a></th><th class="table-header-repeat line-left minwidth-1"> <a onclick="sortingbyfield('price','asc')" id="price" class="cursorpointer">Price</a></th><th class="table-header-repeat line-left minwidth-1"> <a onclick="sortingbyfield('neededPoints','asc')" id="neededPoints" class="cursorpointer">NeededPoints</a></th><th class="table-header-options line-left"><a>Options</a></th>
			</tr>
			<?php
	   $i = 0;
		if($controller_class -> getoffers != ''){
			foreach($controller_class -> getoffers  as $k => $data){
				$i++;
	  ?>
			<tr id="<?php echo $data['id']?>" class="<?php if($i%2==0){ echo "light_bg"; }else{ echo "white_bg"; } ?>" height="30">
			  <td><input  type="checkbox" name="chk_id" id="chk_id" value="<?php echo $data['id'];  ?>"/></td><td class="cursorpointer" onclick="edit('<?php echo $data['id'] ?>','<?php echo $_GET['pid']?>')"><?php echo $data['categoryName']; ?></td><td><?php echo $data['offerName']; ?></td><td><?php echo $data['offerCode']; ?></td><td><?php echo $data['price']; ?></td><td><?php echo $data['neededPoints']; ?></td><td class="options-width" ><table>
				  <tr>
					<td><?php
							if($data['status'] == '1')
							{
