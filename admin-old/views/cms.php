<script type="text/javascript">
	...
	<script type="text/javascript" src="<?=$LOCATION['SITE_ADMIN']?>views/javascripts/cmsscripts.js"></script>
	  ...
	  <table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
		  <tr>
			<td width="635" height="35" class="popup_bg" ><table width="620" border="0" cellspacing="0" cellpadding="0" align="left">
				<tr>
				  <td colspan="2" >Upload Cms CSV</td>
				</tr>
			  </table></td>
		  </tr>
		  <tr>
			<td height="20" align="right" class="popup_listing_border"><a href="<?=$LOCATION['SITE_ADMIN']?>csv-examples/cms.csv">Example of CSV Format</a></td>
		  </tr>
		  <tr>
	...
	<a id="various_2" href="#inline_2"></a><div id="table-content">
	  ...
	  <div id="<?php echo $_GET['pid'] ?>" >
		...
		<form id="form_cmsview" action="" name="form_cmsview" method="post" enctype="multipart/form-data" >
	   ...
	   $i = 0;
		if($controller_class -> getcms != ''){
			foreach($controller_class -> getcms  as $k => $data){
				$i++;
	  ?>
