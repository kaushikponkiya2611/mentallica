...
<script type="text/javascript" src="<?= $LOCATION['SITE_ADMIN'] ?>views/javascripts/category_artistscripts.js"></script>
        ...
        <table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                <td width="635" height="35" class="popup_bg" ><table width="620" border="0" cellspacing="0" cellpadding="0" align="left">
                        <tr>
                            <td colspan="2" >Upload Category_artist CSV</td>
                        </tr>
                    </table></td>
            </tr>
            <tr>
                <td height="20" align="right" class="popup_listing_border"><a href="<?= $LOCATION['SITE_ADMIN'] ?>csv-examples/category_artist.csv">Example of CSV Format</a></td>
            </tr>
            <tr>
                    ...
                    <form id="form_search" action="" name="form_search" method="post" enctype="multipart/form-data" >
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td width="130" align="right" class="popup_listing_border" valign="middle"><strong>CategoryName:</strong></td>
                                ...
                                <td width="459" align="left" class="popup_listing_border" valign="middle">
                                    <input type="text" class="input_box"  name="txt_srccategoryName" id="txt_srccategoryName" />	  
                                </td>
...
<a id="various_2" href="#inline_2"></a><div id="table-content">
    ...
    <div id="<?php echo $_GET['pid'] ?>" >
            ...
            <table class="searchdiv" border="0" width="100%" cellpadding="0" cellspacing="0">
                <tr>
                    <td width="13%" align="left"><?php
                        /*if ($controller_class->getcategory_artist != '') {
                            ?>
        ...
        <form id="form_category_artistview" action="" name="form_category_artistview" method="post" enctype="multipart/form-data" >
            <table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
                <tr>
                    <th class="table-header-check"><a id="toggle-all" ></a> </th><th class="table-header-repeat line-left minwidth-1"> <a onclick="sortingbyfield('categoryName', 'asc')" id="categoryName" class="cursorpointer">CategoryName</a></th><th class="table-header-options line-left"><a>Options</a></th>
                </tr>
                <?php
                $i = 0;
                if ($controller_class->getcategory_artist != '') {
                    foreach ($controller_class->getcategory_artist as $k => $data) {
                        $i++;
                        ?>
                        ...
                        ?>" height="30">
                            <td><input  type="checkbox" name="chk_id" id="chk_id" value="<?php echo $data['id']; ?>"/></td><td class="cursorpointer" onclick="edit('<?php echo $data['id'] ?>', '<?php echo $_GET['pid'] ?>')"><?php echo $data['categoryName']; ?></td><td class="options-width" ><table>
                                    <tr>
                                        <!--<td><?php
                                            if ($data['status'] == '1') {
                                                ?>
                                        ...
                                        <td><a style="cursor:pointer" title="Assign Artist" onclick="edit('<?php echo $data['id'] ?>', '<?php echo $_GET['pid'] ?>')">Assign Artist</a></td>
