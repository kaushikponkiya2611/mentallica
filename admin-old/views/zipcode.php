...
<script type="text/javascript" src="<?=$LOCATION['SITE_ADMIN']?>views/javascripts/zipcodescript.js"></script>
  ...
  <table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td width="635" height="35" class="popup_bg" ><table width="620" border="0" cellspacing="0" cellpadding="0" align="left">
            <tr>
              <td colspan="2" >Upload User CSV</td>
            </tr>
          </table></td>
      </tr>
      <tr>
        <td height="20" align="right" class="popup_listing_border"><a href="<?=$LOCATION['SITE_ADMIN']?>csv-examples/user.csv">Example of CSV Format</a></td>
      </tr>
      <tr>
        ...
        <td height="100" align="center" valign="top" style="padding-left:12px;">
        	<form id="form_search" action="" name="form_search" method="post" enctype="multipart/form-data" >
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td height="20" align="center" class="popup_listing_border_search" colspan="3" id="searchmsg">
                     </td>                   
                  </tr>				  
				  <tr class="light_bg">
					<td width="120" align="right" class="popup_listing_border" valign="middle"><strong>Zipcode:</strong></td>
					<td width="11" height="37" align="left" class="popup_listing_border">&nbsp;</td>
					<td width="469" align="left" class="popup_listing_border" valign="middle">
					<input type="text" class="inp-form"  name="txt_srchfname" id="txt_srchfname"  />
					</td>
				  </tr>
				  <tr class="white_bg">
					<td width="120" align="right" class="popup_listing_border" valign="middle"><strong>Country Name:</strong></td>
					<td width="11" height="37" align="left" class="popup_listing_border">&nbsp;</td>
					<td width="469" align="left" class="popup_listing_border" valign="middle">
					<input type="text" class="inp-form"  name="txt_countrya" id="txt_countrya"  />
					</td>
				  </tr>
				  <tr class="light_bg">
					<td width="120" align="right" class="popup_listing_border" valign="middle"><strong>State Name:</strong></td>
					<td width="11" height="37" align="left" class="popup_listing_border">&nbsp;</td>
					<td width="469" align="left" class="popup_listing_border" valign="middle">
					<input type="text" class="inp-form"  name="txt_statea" id="txt_statea"  />
					</td>
				  </tr>
				  <tr class="white_bg">
					<td width="120" align="right" class="popup_listing_border" valign="middle"><strong>City Name:</strong></td>
					<td width="11" height="37" align="left" class="popup_listing_border">&nbsp;</td>
					<td width="469" align="left" class="popup_listing_border" valign="middle">
					<input type="text" class="inp-form"  name="txt_citya" id="txt_citya"  />
					</td>
				  </tr>				  
				  <tr class="light_bg">
					<td align="right">&nbsp;</td>
...
<table class="searchdiv" border="0" width="100%" cellpadding="0" cellspacing="0">
   <tr>
	...
	if($controller_class -> getzipcode != ''){
	?>
	<div id="actions-box">
	...
	<tr>
		...
		<th class="table-header-repeat line-left minwidth-1"> <a onclick="sortingbyfield('z.zipCode','asc')" id="z_zipCode" class="cursorpointer">Zipcode </a></th>
		<th class="table-header-repeat line-left minwidth-1"> <a onclick="sortingbyfield('co.countryName','asc')" id="co_countryName" class="cursorpointer">Country Name </a></th>
		<th class="table-header-repeat line-left minwidth-1"> <a onclick="sortingbyfield('s.stateName','asc')" id="s_stateName" class="cursorpointer">State Name </a></th>
		<th class="table-header-repeat line-left minwidth-1"> <a onclick="sortingbyfield('c.cityName','asc')" id="c_cityName" class="cursorpointer">City Name </a></th>	
		<th class="table-header-options line-left"><a href="">Options</a></th>
	</tr>
   <?php
   $i = 0;
	if($controller_class -> getzipcode != ''){
		foreach($controller_class -> getzipcode  as $k => $data){
			$i++;
  ?>
	<tr id="<?php echo $data['Id']?>" class="<?php if($i%2==0){ echo "light_bg"; }else{ echo "white_bg"; } ?>" height="30">
		...
		<td class="cursorpointer" onclick="edit('<?php echo $data['Id'] ?>','<?php echo $_GET['pid']?>')"><?php echo $data['zipCode']; ?></td>
