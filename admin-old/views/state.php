...
<script type="text/javascript" src="<?php echo $LOCATION['SITE_ADMIN']?>views/javascripts/statescript.js"></script>
...
<div style="display:none;">
  ...
  <table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td height="20" align="right" class="popup_listing_border"><a href="<?php echo $LOCATION['SITE_ADMIN']?>csv-examples/user.csv">Example of CSV Format</a></td>
      </tr>
      <tr>
        	...
        	<form id="form_search" action="" name="form_search" method="post" enctype="multipart/form-data" >
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
				  ...
				  <tr class="white_bg">
					...
					<td width="11" height="37" align="left" class="popup_listing_border">&nbsp;</td>
					<td width="469" align="left" class="popup_listing_border" valign="middle">
					<input type="text" class="inp-form"  name="txt_country" id="txt_country"  />
					</td>
				  </tr>
				  <tr class="light_bg">
					<td align="right">&nbsp;</td>
...
<table class="searchdiv" border="0" width="100%" cellpadding="0" cellspacing="0">
   <tr>
	...
	<tr>
		...
		<a onclick="sortingbyfield('s.name','asc')" id="s_name" class="cursorpointer">State Name </a></th>
		<th class="table-header-repeat line-left minwidth-1">
		<a onclick="sortingbyfield('countryName','asc')" id="cr_countryName" class="cursorpointer">Country Name </a></th>
		<th class="table-header-options line-left"><a>Options</a></th>
	</tr>
   <?php
   $i = 0;
	if($controller_class -> getstate != ''){
		foreach($controller_class -> getstate  as $k => $data){
			$i++;
  ?>
	<tr id="<?php echo $data['id']?>" class="<?php if($i%2==0){ echo "light_bg"; }else{ echo "white_bg"; } ?>" height="30">
		...
		<td class="cursorpointer" onclick="edit('<?php echo $data['id'] ?>','<?php echo $_GET['pid']?>')"><?php echo stripslashes($data['name']); ?></td>
