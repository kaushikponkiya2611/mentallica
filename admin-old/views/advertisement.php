<script type="text/javascript">
	...
	<script type="text/javascript" src="<?=$LOCATION['SITE_ADMIN']?>views/javascripts/advertisementscripts.js"></script>
	  ...
	  <table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
		  <tr>
			<td width="635" height="35" class="popup_bg" ><table width="620" border="0" cellspacing="0" cellpadding="0" align="left">
				<tr>
				  <td colspan="2" >Upload Advertisement CSV</td>
				</tr>
			  </table></td>
		  </tr>
		  <tr>
			<td height="20" align="right" class="popup_listing_border"><a href="<?=$LOCATION['SITE_ADMIN']?>csv-examples/advertisement.csv">Example of CSV Format</a></td>
		  </tr>
		  <tr>
	  ...
	  <div id="<?php echo $_GET['pid'] ?>" >
		<div class="searchdiv">
		  <table class="searchdiv" border="0" width="100%" cellpadding="0" cellspacing="0">
			...
			if($controller_class -> getadvertisement != ''){
			?>
		...
		<form id="form_advertisementview" action="" name="form_advertisementview" method="post" enctype="multipart/form-data" >
	   ...
	   $i = 0;
		if($controller_class -> getadvertisement != ''){
			foreach($controller_class -> getadvertisement  as $k => $data){
				$i++;
	  ?>
