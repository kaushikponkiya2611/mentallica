<?php 
	...
	?>
	<script type="text/javascript" src="<?=$LOCATION['SITE_ADMIN']?>views/javascripts/js/jquery.form.js"></script><form name="form_categoryadd" id="form_categoryadd" method="post" enctype="multipart/form-data" action="#" >
