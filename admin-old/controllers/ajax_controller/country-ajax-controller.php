...
if(isset($_POST['view']) && $_POST['view'] != ''){
    ...
    $qry = "SELECT * FROM tbl_country WHERE Id = '".mysql_real_escape_string($id)."'";
	$result = $modelObj->fetchRow($qry);
?>
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size:13px">
      <tr class="light_bg">
        ...
        <td width="469" align="left" class="popup_listing_border"><?php echo stripslashes($result['countryName']) ?></td>
      </tr>
      <tr class="white_bg">
...
if(isset($_POST['hid_add']) && $_POST['hid_add'] != ''){
    ...
    $qry = "SELECT countryName FROM tbl_country WHERE status!=2 and countryName = '".mysql_real_escape_string(trim($_POST['txt_country']))."'";
	$result = $modelObj -> fetchRow($qry);
	
	if(strtolower(trim($result['countryName'])) == strtolower(trim($_POST['txt_country'])))
	{
		$flag = 0;
	}
	else
...
<form name="form_useradd" id="form_useradd" method="post" enctype="multipart/form-data" action="#" >
	<table border="0" cellpadding="0" cellspacing="0"  id="id-form" width="100%">
		<tr class="light_bg">
			<th>Country Name :</th>
			<td width="25%"><input type="text" class="input_box"  name="txt_country" id="txt_country" value="<?php echo stripslashes($data['countryName']) ?>" onblur="checkfield(this)" /><font class="required"> *</font></td>
