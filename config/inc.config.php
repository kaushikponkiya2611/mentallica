...
switch ($_SERVER['DOCUMENT_ROOT']) {
    case '/home10/mentalli/public_html':
        ...
        $APP_FOLDER = '';
        $ADMIN_DOMAIN_NAME = $protocol . "://" . $_SERVER['HTTP_HOST'] . "/projectone/";
        $FRNT_DOMAIN_NAME = $protocol . "://" . $_SERVER['HTTP_HOST'] . "/projectone/";

        $APP_PATH = $_SERVER["DOCUMENT_ROOT"] . "/projectone/";
        $ADMIN_APP_PATH = $_SERVER["DOCUMENT_ROOT"] . "/projectone/";
...
$LOCATION['PAYPAL_ID'] = 'https://www.sandbox.paypal.com/cgi-bin/webscr';
$LOCATION['PAYPAL_URL'] = 'scampi-facilitator@mentallica.com';
...
$_SESSION['databasename'] = "projectone";
$_SESSION['sitefoldername'] = "/projectone/admin/";
//CONSTANTS
define("PAYPAL_URL","https://www.sandbox.paypal.com/cgi-bin/webscr");
define("PAYPAL_ID","kaushikponkiya-facilitator@outlook.com");
